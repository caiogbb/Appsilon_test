      ...
      column(width = 9,
             box(width = NULL, solidHeader = TRUE,
                 ...
                 div(id = "introscreen",
                     ...
                     h2("Instructions:"),
                     "",
                     h4("1 - In the top right corner there is a field called 'Choose the name type'. In this case, you can choose whether you want to search the map for the Scientific name or vernacular name you want to investigate. Then, choose which species name in 'Choose the name' you want to search for and when choosing, click on the button called 'Search by species' and the points on the map where the species was found will be shown and just below the button a timeline will be shown (time series) of the number of species that have been found in Poland."),
                     "",
                     h4("2 - Note that the map and time series will only appear or update when you choose the vernacular name or scientific name option and the specific name and click the button! Only when you click the button will the results be shown!"),
                     "",
